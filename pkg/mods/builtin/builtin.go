...
func RegisterCmdsFindingCmds(cmds *model.CmdTree) {
...
func RegisterTailSubCmds(cmds *model.CmdTree) {
...
func RegisterCmdsListCmds(cmds *model.CmdTree) {
	addDumpCmdsArgs := func(cmd *model.Cmd) {
		cmd.SetPriority().
			SetQuiet().
			SetIgnoreFollowingDeps().
			SetAllowTailModeCall().
...
func RegisterTagsCmds(cmds *model.CmdTree) {
	cmds.AddSub("tags").
...
func RegisterFlowDescCmds(cmds *model.CmdTree) {
...
func RegisterHubManageCmds(cmds *model.CmdTree) {
...
func RegisterEnvManageCmds(cmds *model.CmdTree) *model.CmdTree {
	...
	env.AddSub("map").
		...
		AddEnvOp("[[dest-key]]", model.EnvOpTypeWrite)
	...
	env.AddSub("set").
		...
		AddArg("key", "", "k").
		AddArg("value", "", "val", "v").
		AddEnvOp("[[key]]", model.EnvOpTypeWrite)
...
func RegisterEnvSnapshotManageCmds(cmds *model.CmdTree) {
...
func RegisterFlowManageCmds(cmds *model.CmdTree) {
...
func RegisterBgManageCmds(cmds *model.CmdTree) {
...
func RegisterSessionCmds(cmds *model.CmdTree) {
...
func RegisterBlenderCmds(cmds *model.CmdTree) {
...
func RegisterDbgCmds(cmds *model.CmdTree) {
...
func RegisterVerbCmds(cmds *model.CmdTree) {
	cmds.AddSub("quiet", "q").
...
func RegisterBuiltinCmds(cmds *model.CmdTree) {
	env := cmds.AddSub("env", "e")
...
func RegisterTimerCmds(cmds *model.CmdTree) {
	...
	timer.AddSub("begin").
		...
		AddEnvOp("[[begin-key]]", model.EnvOpTypeWrite)
	...
	timer.AddSub("elapsed", "elapse", "end").
		...
		AddArg("write-to-key", "", "key", "k").
		AddEnvOp("[[begin-key]]", model.EnvOpTypeRead).
		AddEnvOp("[[write-to-key]]", model.EnvOpTypeWrite)
}

func RegisterOsCmds(cmds *model.CmdTree) {
	cmds.AddSub("bash").
...
func RegisterJoinCmds(cmds *model.CmdTree) {
...
func RegisterNoopCmds(cmds *model.CmdTree) {
	cmds.AddSub("noop").
		RegPowerCmd(Noop,
			"do exactly nothing")
...
func RegisterHookCmds(cmds *model.CmdTree) {
...
func RegisterApiCmds(cmds *model.CmdTree) {
	cmd := cmds.AddSub("cmd")
...
func registerSimpleSwitch(
	parent *model.CmdTree,
	function string,
	key string,
	name string,
	abbrs ...string) *model.CmdTree {
